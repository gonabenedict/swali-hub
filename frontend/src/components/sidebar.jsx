...
const Sidebar = () => {
  ...
  //here the function will handle what you select the tech
          ...
          <div className={sidebarStyles.sidebarHeader}>
            ...
            <div className={sidebarStyles.headerContent}>
              <div className={sidebarStyles.logoContainer}>
                ...
                <div>
                  <h1 className={sidebarStyles.logoTitle}> Tech Stacks </h1>
          ...
          <div>
            <div className={sidebarStyles.sidebarFooter}>
              <div className={sidebarStyles.footerContent}>
                <p className={sidebarStyles.footerContentCenter}>
