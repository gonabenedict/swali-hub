export const navbarStyles = {
  ...
  // Decorative pattern
  decorativePattern: "hidden",
  decorativePatternBackground: `none`,
...
export const footerStyles = {
  footer: "w-full bg-gradient-to-r from-blue-100 to-purple-100 text-gray-600 py-6 mt-auto",
  container: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 text-center",
  text: "text-sm sm:text-base font-medium",
  highlight: "font-bold text-purple-500"
};